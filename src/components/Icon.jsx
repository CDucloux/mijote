...
export const Icon = ({ name, size = 20, color = "currentColor" }) => {
  ...
  const icons = {
    ...
    thinking: <svg {...p}><circle cx="9.5" cy="9.5" r="6.5" /><circle cx="7.4" cy="8.6" r=".5" fill={color} /><path d="M7 12c1.2 1 3.5 1 4.7 0" /><circle cx="18" cy="17" r="1.7" /><circle cx="21" cy="20.4" r=".9" /></svg>,
