...
export const Icon = ({ name, size = 20, color = "currentColor" }) => {
  ...
  const icons = {
    ...
    warning: <svg {...p} strokeWidth="2"><path d="M10.29 1.36 1.82 15.5a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 1.36a2 2 0 0 0-3.42 0z"/><line x1="12" y1="6.5" x2="12" y2="10.5"/><line x1="12" y1="14.5" x2="12.01" y2="14.5"/></svg>,
