...
export const Icon = ({ name, size = 20, color = "currentColor" }) => {
  ...
  const icons = {
    ...
    thinking: <svg {...p}><path d="M9.5 3A6.5 6.5 0 0 1 16 9.5c0 1.6-.6 2.7-1.5 3.8-.6.7-1 1.2-1 2.2V16H8v-.5c0-1-.4-1.5-1-2.2C6.1 12.2 5.5 11.1 5.5 9.5" /><path d="M8 19h6" /><path d="M9 21.5h4" /><path d="M19 6.5l1.6-.8M19.5 10l1.7.3" /></svg>,
