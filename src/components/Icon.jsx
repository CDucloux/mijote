...
export const Icon = ({ name, size = 20, color = "currentColor" }) => {
  ...
  const icons = {
    ...
    utensils: <svg {...p}><path d="M5 2.5v4.5"/><path d="M11 2.5v4.5"/><path d="M8 2.5v19"/><path d="M5 7a3 3 0 0 0 6 0"/><path d="M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3zm0 0v7"/></svg>,
