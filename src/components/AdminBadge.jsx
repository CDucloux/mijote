...
export function AdminBadge({ size = "sm" }) {
  ...
  return (
    <span style={{ display: "inline-flex", alignItems: "center", gap: 4, height: s.h, padding: `0 ${s.padX}px`, boxSizing: "border-box", lineHeight: 1, borderRadius: 999, background: "var(--admin)", color: "#fff", fontFamily: "var(--ff-body)", fontSize: s.fs, fontWeight: 600, letterSpacing: "0.01em", whiteSpace: "nowrap" }}>
