  ...
  return (
    <div style={{ position: "relative", height: HERO_H, flexShrink: 0, color: "#fff", overflow: "hidden" }}>
      ...
      <div style={{ position: "absolute", bottom: 16, left: 18, right: 18 }}>
        <h1 ref={titleRef} style={{ fontFamily: "var(--ff-display)", fontSize: 26, fontWeight: 700, letterSpacing: "-0.02em", lineHeight: 1.1, marginBottom: 4, color: "#fff", transformOrigin: "left bottom", willChange: "transform, opacity" }}>{recipe.name}</h1>
