...
export function ShareSheet({ recipe, publicUrl, shareText, onCopyLink, onNativeShare, onClose }) {
  ...
  return (
    <SwipeableSheet onClose={onClose}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 13, padding: 11, borderRadius: 16, background: "var(--surface)", border: "1px solid var(--border)", boxShadow: "0 4px 14px rgba(0,0,0,0.06)", marginBottom: 20 }}>
        <div style={{ width: 66, height: 66, borderRadius: 14, overflow: "hidden", flexShrink: 0, boxShadow: "0 2px 8px rgba(0,0,0,0.12)" }}>
      ...
      {/* Options de partage */}
      <div style={{ display: "flex", gap: 8, justifyContent: "space-around", marginBottom: 6 }}>
        {opt("Copier le lien", (
          <svg width="23" height="23" viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="9" y="9" width="11" height="11" rx="2.5" stroke="var(--accent)" strokeWidth="1.9" /><path d="M6 15H5.5A2.5 2.5 0 0 1 3 12.5v-7A2.5 2.5 0 0 1 5.5 3h7A2.5 2.5 0 0 1 15 5.5V6" stroke="var(--accent)" strokeWidth="1.9" strokeLinecap="round" /></svg>
        ), onCopyLink, "accent")}
        {opt("WhatsApp", (
