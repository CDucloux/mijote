...
const SLIDES = [
  {
    ...
    text: <>Ton <strong>compagnon de cuisine</strong>, pas une énième appli où ranger des recettes : ici elles prennent vie, s'affinent à chaque essai et te suivent <em>des courses jusqu'aux fourneaux</em>.</>,
  },
  {
