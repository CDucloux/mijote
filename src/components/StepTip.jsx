...
export function StepTip({ tip, size = "sm", style }) {
  ...
  return (
    <div style={{
      ...
      borderRadius: 12, padding: lg ? "13px 15px" : "11px 13px", ...style,
    }}>
      ...
      <div style={{ minWidth: 0, flex: 1 }}>
        <div style={{ fontSize: 10.5, fontWeight: 800, letterSpacing: "0.09em", textTransform: "uppercase", color: "var(--blue)", marginBottom: 3 }}>Astuce</div>
        <p style={{ fontSize: lg ? 15 : 13, color: "var(--text2)", lineHeight: 1.55, margin: 0, wordBreak: "break-word", overflowWrap: "break-word" }}>{tip}</p>
      </div>
    </div>
  );
}
