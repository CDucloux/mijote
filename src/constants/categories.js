...
export const DEFAULT_CATEGORIES = {
  ...
  nuts_seeds:   { label: "Noix et graines",         color: "#c8a870", icon: "🥜", order: 9  },
  mushroom:     { label: "Champignons",             color: "#9a9490", icon: "🍄", order: 10 },
  herbs:        { label: "Herbes aromatiques",      color: "#4caf7d", icon: "🌿", order: 11 },
  condiment:    { label: "Condiments/Épices",       color: "#9a9490", icon: "🧂", order: 12 },
  sauce:        { label: "Sauces & condiments",     color: "#c87050", icon: "🥫", order: 13 },
  canned:       { label: "Conserves",               color: "#b08060", icon: "🥫", order: 14 },
  sugar:        { label: "Sucres/Sucrants",         color: "#e05252", icon: "🍬", order: 15 },
  baking:       { label: "Pâtisserie & aides",      color: "#c8a870", icon: "🧁", order: 16 },
  alcohol:      { label: "Alcools",                 color: "#e05252", icon: "🍷", order: 17 },
  other:        { label: "Autres",                  color: "#9a9490", icon: "📦", order: 18 },
};
