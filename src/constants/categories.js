...
export const DEFAULT_CATEGORIES = {
  ...
  legume:       { label: "Légumineuses",            color: "#4caf7d", icon: "🫘", order: 2  },
  grain:        { label: "Céréales",                color: "#c8a870", icon: "🌾", order: 3  },
  meat:         { label: "Viande",                  color: "#c87050", icon: "🥩", order: 4  },
  egg:          { label: "Œufs",                    color: "#f0e060", icon: "🥚", order: 5  },
  fish_seafood: { label: "Poissons/Fruits de mer",  color: "#5b9cf6", icon: "🐟", order: 6  },
  dairy:        { label: "Produits laitiers",       color: "#f0e060", icon: "🧀", order: 7  },
  fat_good:     { label: "Matières grasses saines", color: "#80c080", icon: "🫒", order: 8  },
  oil:          { label: "Huiles",                  color: "#f0c060", icon: "🫙", order: 9  },
  acid:         { label: "Acides & vinaigres",      color: "#c8e060", icon: "🍋", order: 10 },
  nuts_seeds:   { label: "Noix et graines",         color: "#c8a870", icon: "🥜", order: 11 },
  mushroom:     { label: "Champignons",             color: "#9a9490", icon: "🍄", order: 12 },
  herbs:        { label: "Herbes aromatiques",      color: "#4caf7d", icon: "🌿", order: 13 },
  condiment:    { label: "Condiments/Épices",       color: "#9a9490", icon: "🧂", order: 14 },
  sauce:        { label: "Sauces & condiments",     color: "#c87050", icon: "🥫", order: 15 },
  canned:       { label: "Conserves",               color: "#b08060", icon: "🥫", order: 16 },
  sugar:        { label: "Sucres/Sucrants",         color: "#e05252", icon: "🍬", order: 17 },
  baking:       { label: "Pâtisserie & aides",      color: "#c8a870", icon: "🧁", order: 18 },
  alcohol:      { label: "Alcools",                 color: "#e05252", icon: "🍷", order: 19 },
  other:        { label: "Autres",                  color: "#9a9490", icon: "📦", order: 20 },
};
