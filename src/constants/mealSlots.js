...
export const MEAL_SLOTS = [
  ...
  { id: "soir", order: 2, label: "Soir", meal: "Dîner", today: "Ce soir", emoji: "🌙", icon: "moon",
    color: "var(--slot-soir)", text: "var(--slot-soir-text)", accent: "#c56b46", ics: { start: "193000", end: "210000" } },
];
