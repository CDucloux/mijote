...
![Version](https://img.shields.io/badge/version-3.16.0-e8703a?style=for-the-badge)
...
- 📖 **Recettes** : éditeur complet (ingrédients, ustensiles, étapes liées),
  ...
  donne l'**équivalent en cuillères** (à soupe / à café) pour qui n'a pas de balance.
...
| Tests | Vitest 4 (431 tests unitaires sur les libs et hooks critiques) |
