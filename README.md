...
![Version](https://img.shields.io/badge/version-4.52.0-6e9a3f?style=for-the-badge)
...
- 👨‍🍳 **Mode cuisine** : guidage pas-à-pas plein écran, mise en place cochable
  ...
  **minuteurs à notification native** (l'alerte sonne même écran verrouillé), et
  ...
  boutons précédent / pause / suivant) pour garder un œil sur la cuisson en
...
| Tests | Vitest 4 (822 tests unitaires sur les libs et hooks critiques) |
